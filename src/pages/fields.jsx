...
const CreateFormModal = ({ onClose }) => {
  ...
  // Render Fields
  const renderFormField = (fieldType, fieldName, index, fieldLabel, editMode, handleLabelChange, handleEditModeToggle) => {
    const isEditMode = editMode[index];
    fieldName = fieldType; // Set the field name based on the fieldType
      ...
      case 'text':
        return (
          <label key={index}>
            ...
            <input type="text" name={fieldName} placeholder="Text Field" />
          </label>
        );
      case 'textarea':
        return (
