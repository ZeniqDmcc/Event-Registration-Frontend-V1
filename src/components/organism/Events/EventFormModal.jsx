                    ...
                    <Form className='flex flex-col gap-4'>
                      ...
                      <div className={inputRowBoxes}>
                        ...
                        <div className={inputOuter}>
                          ...
                          <Field component={Input} inputType="text" id="eventUrl" name="eventUrl" />
                      ...
                      <div className="flex flex-col gap-5 py-3">
                        ...
                        <div className="">
                          <label className='' htmlFor="banner">Banner</label>
                          {/* <input
                            type="file"
                            id="banner"
                            name="banner"
                      ...
                      <div className='flex justify-between'>
                        <Button customButtonStyle="w-[60%]"
                          inputType="submit"
                          variant="primary">Save and create a form</Button>
                        <Button customButtonStyle="border w-[36%]"
                          inputType="submit"
                          variant="secondary">Save and Exit</Button>
                      </div>
                    </Form>
                  )}
                </Formik>
